$summon item_display ~ ~ ~ {Tags:["structure","feature","ccc","ccc.c4","ccc.c4.machine.root","new"],data:{pieces:$(pieces)},\
                ...
                scale:[0.5,0.5,0.5],\
                translation:[0,1,0]}}
summon interaction ^-1 ^ ^ {Tags:["structure","feature","ccc","ccc.c4","ccc.c4.machine.button","new"], data:{use:{cmd:"function ccc-c4:_place.piece"}}}
summon interaction ^-2 ^ ^ {Tags:["structure","feature","ccc","ccc.c4","ccc.c4.machine.button","new"], data:{use:{cmd:"function ccc-c4:_place.piece"}}}
summon interaction ^-3 ^ ^ {Tags:["structure","feature","ccc","ccc.c4","ccc.c4.machine.button","new"], data:{use:{cmd:"function ccc-c4:_place.piece"}}}
summon interaction ^-4 ^ ^ {Tags:["structure","feature","ccc","ccc.c4","ccc.c4.machine.button","new"], data:{use:{cmd:"function ccc-c4:_place.piece"}}}
summon interaction ^-5 ^ ^ {Tags:["structure","feature","ccc","ccc.c4","ccc.c4.machine.button","new"], data:{use:{cmd:"function ccc-c4:_place.piece"}}}
summon interaction ^-6 ^ ^ {Tags:["structure","feature","ccc","ccc.c4","ccc.c4.machine.button","new"], data:{use:{cmd:"function ccc-c4:_place.piece"}}}
summon interaction ^-7 ^ ^ {Tags:["structure","feature","ccc","ccc.c4","ccc.c4.machine.button","new"], data:{use:{cmd:"function ccc-c4:_place.piece"}}}
