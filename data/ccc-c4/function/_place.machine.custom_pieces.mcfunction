...
$execute align xyz positioned ~0.5 ~ ~0.5 if entity @s[y_rotation=-180..-135] rotated 180 ~ run function ccc-c4:m.place_machine {pieces:[$(pieces)]}
$execute align xyz positioned ~0.5 ~ ~0.5 if entity @s[y_rotation=-135.0001..-45] rotated 270 ~ run function ccc-c4:m.place_machine {pieces:[$(pieces)]}
#
tag @e remove new